...
From the console window, install the Azure Key Vault certificates library for Python.
...
Create an access policy for your key vault that grants permission to your service principal by passing the clientId to the [az keyvault set-policy](/cli/azure/keyvault?view=azure-cli-latest#az-keyvault-set-policy) command. Give the service principal get, list, and create permissions for certificates.
...
The Azure Key Vault client library for Python allows you to manage keys and related assets such as certificates and secrets. The code samples below will show you how to create a client, create a certificate, retrieve a certificate, and delete a certificate.
...
Now that your application is authenticated, you can put a self-signed certificate into your keyvault 
...
You can verify that the certificate has been set with the [az keyvault certificate show](/cli/azure/keyvault/certificate?view=azure-cli-latest#az-keyvault-certificate-show) command:
...
You can now retrieve the previously created certificate

```python
retrieved_certificate = client.get_certificate(certificateName)
 ```

Your certificate is now saved as `retrieved_certificate`.

### Delete a certificate

Finally, let's delete the certificate from your key vault

```python
client.delete_certificate(certificateName)
```

You can verify that the certificate is gone with the [az keyvault certificate show](/cli/azure/keyvault/certificate?view=azure-cli-latest#az-keyvault-certificate-show) command:
